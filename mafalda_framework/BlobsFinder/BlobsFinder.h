 ...
 *
 * This program implements an algorithm that finds blobs in a frame.
 * Those blobs have any possible shape.  'Blob' is understood as any
 * set of adjacent active pixels in an frame.  The work of separating
 * these blobs in different types like: single hits, double, curly,
 * etc, will be done in a separate algorithm.
 */
